...
public class MockFuelDataSource {
    ...
    public static List<FuelRecord> getSampleRecords() {
        ...
        records.add(new FuelRecord("22/04/2026", "Onix", "41.2", "256.34"));
        records.add(new FuelRecord("13/04/2026", "Onix", "38.5", "238.90"));
        records.add(new FuelRecord("03/04/2026", "Onix", "40.0", "248.00"));
